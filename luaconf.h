...
#define luai_numshl(L,a,b)	((a)<<(b))
#define luai_numshr(L,a,b)	((a)>>(b))
#define luai_numlshr(L,a,b)	(fix16_lshr((a),(b)))
#define luai_numrotl(L,a,b)	(fix16_rotl((a),(b)))
#define luai_numrotr(L,a,b)	(fix16_rotr((a),(b)))
