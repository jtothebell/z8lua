...
static inline fix16_t fix16_lshr(fix16_t x, int y) { return y < 0 ? x << -y : y >= 32 ? 0 : x >> y; }

static inline fix16_t fix16_rotl(fix16_t x, int y) { y &= 0x1f; return (x << y) | ((uint32_t)(x) >> (32 - y)); }

static inline fix16_t fix16_rotr(fix16_t x, int y) { y &= 0x1f; return ((uint32_t)(x) >> y) | (x << (32 - y)); }

static inline fix16_t fix16_pow_int(fix16_t x, int y) {
